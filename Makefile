...
cross:
	...
	CC="gcc-7 -m32" CGO_ENABLED=1 GOOS=linux GOARCH=386 go build -ldflags "-X main.version=$(shell git describe --tags --always)" -o "build/kobopatch-linux-32bit" github.com/geek1011/kobopatch/kobopatch
	...
	CC="gcc-7 -m32" CGO_ENABLED=1 GOOS=linux GOARCH=386 go build -ldflags "-X main.version=$(shell git describe --tags --always)" -o "build/kobopatch-apply-linux-32bit" github.com/geek1011/kobopatch/tools/kobopatch-apply
	...
	CC="gcc-7 -m32" CGO_ENABLED=1 GOOS=linux GOARCH=386 go build -ldflags "-X main.version=$(shell git describe --tags --always)" -o "build/kobopatch-mkzlib-linux-32bit" github.com/geek1011/kobopatch/tools/kobopatch-mkzlib
	...
	CC="gcc-7 -m32" CGO_ENABLED=1 GOOS=linux GOARCH=386 go build -ldflags "-X main.version=$(shell git describe --tags --always)" -o "build/cssextract-linux-32bit" github.com/geek1011/kobopatch/tools/cssextract
