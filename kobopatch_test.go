...
func TestResetBaseAddress(t *testing.T) {
	...
	p.cur = 5
	p.ResetBaseAddress()
	eq(t, p.cur, 0, "unexpected base address")
}
...
func TestBaseAddress(t *testing.T) {
	...
	eq(t, p.cur, 4, "unexpected base address")
}
...
func TestFindBaseAddress(t *testing.T) {
	...
	eq(t, p.cur, 8, "unexpected base address")
}
...
func TestAll(t *testing.T) {
	...
	p := NewPatcher(in)
	eq(t, p.cur, 0, "base address should be correct")
	...
	eq(t, p.cur, 0, "base address should be correct")
	nerr(t, p.FindBaseAddress([]byte("a test")))
	eq(t, p.cur, 23, "base address should be correct")
	...
	eq(t, p.cur, 15, "base address should be correct")
